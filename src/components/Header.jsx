...
export default function Header({ carrito, agregarCarrito, quitaUno, quitaGuitarra, vaciarCarrito, guitar }) {
    const total = useMemo(() => carrito.reduce((t, g) => t + g.cantidad* g.precio, 0), [carrito])
